    ...
    <div className="min-h-screen bg-neutral-900 text-white">
      ...
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="text-center mb-16">
          ...
          >
            {t('start_analyzing')} <ArrowRight className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          <div className="bg-neutral-600 bg-opacity-30 p-8 rounded-xl border border-neutral-600">
            ...
            <h3 className="text-xl font-bold mb-3">{t('feature_detection_title')}</h3>
          ...
          <div className="bg-neutral-600 bg-opacity-30 p-8 rounded-xl border border-neutral-600">
            ...
            <h3 className="text-xl font-bold mb-3">{t('feature_accuracy_title')}</h3>
            <p className="text-neutral-300">
              {t('feature_accuracy_desc')}
            </p>
          </div>
          ...
          <div className="bg-neutral-600 bg-opacity-30 p-8 rounded-xl border border-neutral-600">
            ...
            <h3 className="text-xl font-bold mb-3">{t('feature_formats_title')}</h3>
            <p className="text-neutral-300">
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-20 text-center">
          <div>
            ...
            <div className="text-neutral-300">{t('stat_videos_analyzed')}</div>
          </div>
          <div>
            <div className="text-4xl font-bold text-success mb-2">99.2%</div>
            <div className="text-neutral-300">{t('stat_accuracy')}</div>
          </div>
          <div>
            <div className="text-4xl font-bold text-primary mb-2">&lt;3s</div>
            <div className="text-neutral-300">{t('stat_analysis_time')}</div>
          </div>
          <div>
            <div className="text-4xl font-bold text-success mb-2">24/7</div>
            <div className="text-neutral-300">{t('stat_availability')}</div>
          </div>
        </div>
      </div>
    </div>
